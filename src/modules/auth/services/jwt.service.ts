...
import { parseExpiration } from '@/shared/utils/parse-lockfiles.util';
...
export class JwtService {
    ...
    async generateTokenPair(user: User, request?: Request): Promise<TokenResponse> {
        ...
        const refreshExpiresInMs = parseExpiration(jwtRefreshExpiration);
    ...
    async refreshAccessToken(refreshToken: string): Promise<TokenResponse> {
        const entity = await this.validateRefreshToken(refreshToken);
        ...
        return this.generateTokenPair(entity.user);
    }
