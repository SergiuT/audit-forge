...
export class HealthService {
    ...
    private async checkOpenAI(): Promise<HealthCheckResult> {
        ...
        try {
            ...
            const circuitStatus = this.circuitBreakerService.getCircuitStatus('openai-health');
        ...
        try {
            ...
            return {
                ...
                details: {
                    ...
                    cachingEnabled: this.configService.get('ENABLE_CACHING'),
                    secretsManager: this.configService.get('ENABLE_SECRETS_MANAGER'),
                },
            };
        } catch (error) {
            return {
    ...
    private determineOverallHealth(services: HealthCheckResult[]): 'healthy' | 'unhealthy' | 'degraded' {
        ...
        if (unhealthyServices.length > 0) {
            ...
            const criticalDown = unhealthyServices.some(s => criticalServices.includes(s.service));
